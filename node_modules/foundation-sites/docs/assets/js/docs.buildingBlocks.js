...
function addBuildingBlocks(data) {
  ...
  $.each(data, function() {
    html += '<div class="docs-bb"><div class="docs-bb-thumb"><a href="https://zurb.com/building-block/'+this.slug+'"><img src="'+this.image_url+'"/></a></div><div class="docs-bb-main"><h3><a href="https://zurb.com/building-block/'+this.slug+'">'+this.name+'</a></h3><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor, amet incidunt sint esse nihil eum repellendus necessitatibus officiis iusto reprehenderit, alias laudantium veniam ad. Soluta repellat nemo quaerat quis laboriosam.</p></div></div>';
  });

  $('[data-building-block]').each(function() {
    $(this).html(html);
  });

  if ($('[data-building-block] .docs-bb').length === 0) {
    $('.docs-building-block').hide(0);
  }
}
